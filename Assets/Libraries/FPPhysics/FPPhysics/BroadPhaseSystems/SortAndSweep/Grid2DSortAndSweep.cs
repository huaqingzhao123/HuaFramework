...
namespace FPPhysics.BroadPhaseSystems.SortAndSweep
{
    ...
    public class Grid2DSortAndSweep : BroadPhase
    {
        ...
        public static Fix64 CellSize
        {
            get
            {
                return Fix64.C1 / cellSizeInverse;
            }
            set
            {
                cellSizeInverse = Fix64.C1 / value;
            }
        }
        //TODO: Try different values for this.
        internal static Fix64 cellSizeInverse = Fix64.OneEighth;
        ...
        public override void Add(BroadPhaseEntry entry)
        {
            ...
            if (offset.x * offset.y * offset.z == Fix64.C0)
