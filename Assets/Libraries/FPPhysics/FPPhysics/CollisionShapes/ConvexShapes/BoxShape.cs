...
namespace FPPhysics.CollisionShapes.ConvexShapes
{
    ...
    public class BoxShape : ConvexShape
    {
        ...
        public Fix64 Width
        {
            get { return halfWidth * Fix64.C2; }
            set { halfWidth = value * Fix64.C0p5; OnShapeChanged(); }
        }
        ...
        public Fix64 Height
        {
            get { return halfHeight * Fix64.C2; }
            set { halfHeight = value * Fix64.C0p5; OnShapeChanged(); }
        }
        ...
        public Fix64 Length
        {
            get { return halfLength * Fix64.C2; }
            set { halfLength = value * Fix64.C0p5; OnShapeChanged(); }
        }
        ...
        public void Resize(Fix64 width, Fix64 height, Fix64 length)
        {
            halfWidth = width * Fix64.C0p5;
            halfHeight = height * Fix64.C0p5;
            halfLength = length * Fix64.C0p5;
        ...
        public static ConvexShapeDescription ComputeDescription(Fix64 width, Fix64 height, Fix64 length, Fix64 collisionMargin)
        {
            ...
            description.MaximumRadius = Fix64.C0p5 * Fix64.Sqrt(width * width + height * height + length * length);
            description.MinimumRadius = Fix64.C0p5 * MathHelper.Min(width, MathHelper.Min(height, length));
        ...
        public override bool RayTest(ref Ray ray, ref RigidTransform transform, Fix64 maximumLength, out RayHit hit)
        {
            ...
            var tempNormal = new Vector3(-1, Fix64.C0, Fix64.C0);
            if (t1 > t2)
            {
                temp = t1;
                t1 = t2;
