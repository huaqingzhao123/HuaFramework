...
namespace FPPhysics.CollisionShapes.ConvexShapes
{
    ...
    public class TriangleShape : ConvexShape
    {
        ...
        public TriangleShape(Vector3 vA, Vector3 vB, Vector3 vC)
        {
            ...
            Vector3 center = (vA + vB + vC) / Fix64.C3;
            this.vA = vA - center;
            this.vB = vB - center;
            this.vC = vC - center;
        ...
        public static ConvexShapeDescription ComputeDescription(Vector3 vA, Vector3 vB, Vector3 vC, Fix64 collisionMargin)
        {
            ...
            var v = new Matrix3x3(
                ...
                vC.x, vC.y, vC.z);
            var s = new Matrix3x3(
                Fix64.C2, Fix64.C1, Fix64.C1,
                Fix64.C1, Fix64.C2, Fix64.C1,
                Fix64.C1, Fix64.C1, Fix64.C2);
            ...
            var scaling = doubleArea / Fix64.C24;
        ...
        {
            Vector3 center = (vA + vB + vC) * Fix64.OneThird;

            //Calculate distribution of mass.

            Fix64 massPerPoint = Fix64.OneThird;
