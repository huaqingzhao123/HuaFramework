...
namespace FPPhysics.Character
{
    ...
    public class StanceManager
    {
        ...
        public Fix64 StandingHeight
        {
            ...
            set
            {
                if (value <= Fix64.C0 || value < CrouchingHeight)
        ...
        public Fix64 CrouchingHeight
        {
            ...
            set
            {
                if (value <= Fix64.C0 || value > StandingHeight)
        ...
        private void PrepareQueryObject(EntityCollidable queryObject, ref Vector3 position)
        {
            ...
            queryObject.UpdateBoundingBoxForTransform(ref transform, Fix64.C0);
        }
            ...
            if (CurrentStance != targetStance)
            {
                ...
                if (currentHeight >= targetHeight)
                {
                    ...
                    if (SupportFinder.HasSupport)
                    {
                        ...
                        newPosition = currentPosition + down * ((currentHeight - targetHeight) * Fix64.C0p5);
                    }
                    else
                    {
                ...
                try
                {
                    if (SupportFinder.HasSupport)
                    {
                        ...
                        newPosition = currentPosition - down * ((targetHeight - currentHeight) * Fix64.C0p5);
                    ...
                    else
                    {
                        ...
                        Fix64 lowestBound = Fix64.C0;
                        Fix64 originalHighestBound = (targetHeight - currentHeight) * -Fix64.C0p5;
                        Fix64 highestBound = originalHighestBound;
                        Fix64 currentOffset = Fix64.C0;
                        ...
                        while (attempts++ < 5 && lowestBound - highestBound > Toolbox.BigEpsilon)
                        {
                            ...
                            switch (lastState = TrySupportLocation(queryObject, ref candidatePosition, out hintOffset, ref tractionContacts, ref supportContacts, ref sideContacts, ref headContacts))
                            {
                                case CharacterContactPositionState.Accepted:
                                    ...
                                    if (currentOffset <= Fix64.C0 && currentOffset >= originalHighestBound)
                                    {
