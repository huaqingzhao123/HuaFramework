...
namespace FPPhysics.Character
{
    ...
    public class VerticalMotionConstraint : SolverUpdateable
    {
        ...
        Fix64 supportForceFactor = Fix64.C1;
        /// <summary>
        ...
        public override void Update(Fix64 dt)
        {
            ...
            permittedVelocity = MathHelper.Min(MathHelper.Max(supportData.Depth * CollisionResponseSettings.PenetrationRecoveryStiffness / dt, Fix64.C0), CollisionResponseSettings.MaximumPenetrationRecoverySpeed);
            ...
            effectiveMass = Fix64.C1 / (inverseEffectiveMass);
        ...
        public override Fix64 SolveIteration()
        {
            ...
            accumulatedImpulse = MathHelper.Clamp(accumulatedImpulse + lambda, Fix64.C0, maximumForce);
