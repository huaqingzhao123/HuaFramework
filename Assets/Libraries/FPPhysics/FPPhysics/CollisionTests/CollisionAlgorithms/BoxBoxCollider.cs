...
namespace FPPhysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class BoxBoxCollider
    {
        ...
        public static bool AreBoxesCollidingWithPenetration(BoxShape a, BoxShape b, ref RigidTransform transformA, ref RigidTransform transformB, out Fix64 distance, out Vector3 axis)
        {
            ...
            if (tl > Fix64.C0)
            {
                tempAxis = new Vector3(aO.M12 * bO.M13 - aO.M13 * bO.M12,
                                       aO.M13 * bO.M11 - aO.M11 * bO.M13,
                                       aO.M11 * bO.M12 - aO.M12 * bO.M11);
                axisLengthInverse = Fix64.C1 / tempAxis.Length();
...
#endif
        {
            ...
            Fix64 antiEdgeBias = Fix64.C0p01;
...
#endif
        {
            ...
            contactData = new TinyStructList<BoxContactData>();
                ...
                if (GetClosestPointsBetweenSegments(ref edgeAStart1, ref edgeAEnd1, ref edgeBStart1, ref edgeBEnd1, out onA, out onB))
                {
                    ...
                    if (dot < Fix64.C0) //Distance must be negative.
                    {
                        BoxContactData data;
                        data.Position = onA;
                        data.Depth = dot;
        ...
        private static unsafe void ClipFacesDirect(ref BoxFace clipFace, ref BoxFace face, ref Vector3 mtd, out BoxContactDataCache outputData)
        {
            ...
            Fix64 inverseClipWidth = Fix64.C1 / clipFace.Width;
            Fix64 inverseClipHeight = Fix64.C1 / clipFace.Height;
            ...
            Fix64 inverseFaceWidth = Fix64.C1 / face.Width;
            Fix64 inverseFaceHeight = Fix64.C1 / face.Height;
            ...
            clipCenterX *= Fix64.C0p5;
            clipCenterY *= Fix64.C0p5;
            ...
            faceCenterX *= Fix64.C0p5;
            faceCenterY *= Fix64.C0p5;
            ...
            Fix64 extentX = Fix64.C0p5 + Fix64.C0p01 * inverseClipWidth;
            Fix64 extentY = Fix64.C0p5 + Fix64.C0p01 * inverseClipHeight;
            ...
            extentX = Fix64.C0p5 + Fix64.C0p01 * inverseFaceWidth;
            extentY = Fix64.C0p5 + Fix64.C0p01 * inverseFaceHeight;
        ...
        private static bool ComputeIntersection(ref Vector3 edgeA1, ref Vector3 edgeA2, ref FaceEdge clippingEdge, out Vector3 intersection)
        {
            ...
            if (t < Fix64.C0 || t > edgeDirection.LengthSquared())
            {
        ...
        private static void GetNearestFace(ref Vector3 position, ref Matrix3x3 orientation, ref Vector3 mtd, Fix64 halfWidth, Fix64 halfHeight, Fix64 halfLength, out BoxFace boxFace)
        {
            ...
            if (absX > absY && absX > absZ)
            {
                ...
                Matrix4x4.Transform(ref candidate, ref worldTransform, out candidate);
                ...
                boxFace.Width = halfHeight * Fix64.C2;
                boxFace.Height = halfLength * Fix64.C2;
            ...
            else if (absY > absX && absY > absZ)
            {
                ...
                boxFace.Width = halfWidth * Fix64.C2;
                boxFace.Height = halfLength * Fix64.C2;
            ...
            else if (absZ > absX && absZ > absY)
            {
                ...
                boxFace.Width = halfWidth * Fix64.C2;
                boxFace.Height = halfHeight * Fix64.C2;
