namespace FPPhysics
{
    ...
    public struct Matrix3x3
    {
        ...
        {
            get { return new Matrix3x3(Fix64.C1, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C1, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C1); }
        }
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref Matrix4x4 a, ref Matrix3x3 b, out Matrix3x3 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
            Fix64 m13 = a.M13 + b.M13;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref Matrix3x3 a, ref Matrix4x4 b, out Matrix3x3 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
            Fix64 m13 = a.M13 + b.M13;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref Matrix4x4 a, ref Matrix4x4 b, out Matrix3x3 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
            Fix64 m13 = a.M13 + b.M13;
        ...
        public static Matrix3x3 CreateFromMatrix(Matrix4x4 matrix4X4)
        {
            Matrix3x3 matrix3X3;
            matrix3X3.M11 = matrix4X4.M11;
            matrix3X3.M12 = matrix4X4.M12;
        ...
        public static void AdaptiveInvert(ref Matrix3x3 matrix, out Matrix3x3 result)
        {
            ...
            int submatrix;
            Fix64 determinantInverse = Fix64.C1 / matrix.AdaptiveDeterminant(out submatrix);
            ...
            switch (submatrix)
            {
                ...
                case 6: //M33
                    ...
                    m31 = Fix64.C0;
                    m32 = Fix64.C0;
                    m33 = Fix64.C1 / matrix.M33;
                    break;

                default: //Completely singular.
                    m11 = Fix64.C0; m12 = Fix64.C0; m13 = Fix64.C0; m21 = Fix64.C0; m22 = Fix64.C0; m23 = Fix64.C0; m31 = Fix64.C0; m32 = Fix64.C0; m33 = Fix64.C0;
                    break;
            }
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref Matrix3x3 a, ref Matrix4x4 b, out Matrix3x3 result)
        {
            Fix64 resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31;
            Fix64 resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32;
            Fix64 resultM13 = a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33;
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref Matrix4x4 a, ref Matrix3x3 b, out Matrix3x3 result)
        {
            Fix64 resultM11 = a.M11 * b.M11 + a.M12 * b.M21 + a.M13 * b.M31;
            Fix64 resultM12 = a.M11 * b.M12 + a.M12 * b.M22 + a.M13 * b.M32;
            Fix64 resultM13 = a.M11 * b.M13 + a.M12 * b.M23 + a.M13 * b.M33;
        ...
        /// <param name="matrix">Matrix to transpose.</param>
        /// <param name="result">Transposed matrix.</param>
        public static void Transpose(ref Matrix4x4 matrix, out Matrix3x3 result)
        {
            Fix64 m21 = matrix.M12;
            Fix64 m31 = matrix.M13;
            Fix64 m12 = matrix.M21;
