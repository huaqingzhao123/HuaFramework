...
namespace FPPhysics.NarrowPhaseSystems.Pairs
{
    ...
    public class DetectorVolumeMobileMeshPairHandler : DetectorVolumePairHandler
    {
        ...
        private TriangleShape detectorTriangle = new TriangleShape { collisionMargin = Fix64.C0 };
        ...
        public override void UpdateCollision(Fix64 dt)
        {
            ...
            for (int i = 0; i < meshData.Indices.Length; i += 3)
            {
                ...
                Vector3.Multiply(ref mobileTriangleTransform.Position, Fix64.OneThird, out mobileTriangleTransform.Position);
                ...
                for (int j = 0; j < overlaps.Count; j++)
                {
                    ...
                    Vector3.Multiply(ref detectorTriangleTransform.Position, Fix64.OneThird, out detectorTriangleTransform.Position);
