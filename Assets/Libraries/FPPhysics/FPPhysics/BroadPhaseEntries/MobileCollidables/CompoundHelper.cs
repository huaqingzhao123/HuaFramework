...
namespace FPPhysics.BroadPhaseEntries.MobileCollidables
{
    /// <summary>
    ...
    public static class CompoundHelper
    {
            ...
            out Fix64 weightA, out Fix64 weightB)
        {
            ...
            Matrix3x3.Multiply(ref distributionInfoA.VolumeDistribution, Fix64.C1 / weightA, out distributionInfoA.VolumeDistribution);
            Matrix3x3.Multiply(ref distributionInfoB.VolumeDistribution, Fix64.C1 / weightB, out distributionInfoB.VolumeDistribution);
           ...
           out ShapeDistributionInformation distributionInfo, out Fix64 weight, out Fix64 removedWeight, out Vector3 removedCenter)
        {
            ...
            //Normalize the volume distribution.
            Matrix3x3.Multiply(ref distributionInfo.VolumeDistribution, Fix64.C1 / weight, out distributionInfo.VolumeDistribution);
