using FPPhysics.BroadPhaseEntries.Events;
    ...
    public class MobileMeshCollidable : EntityCollidable
    {
        ...
        public override bool RayCast(Ray ray, Fix64 maximumLength, out RayHit rayHit)
        {
            ...
            if (Shape.solidity == MobileMeshSolidity.Solid)
            {
                ...
                {
                    //It was inside!
                    rayHit = new RayHit() { Location = ray.Position, Normal = Vector3.zero, T = Fix64.C0 };
                    return true;
        ...
        public override bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3 sweep, out RayHit hit)
        {
            if (Shape.solidity == MobileMeshSolidity.Solid)
            {
                ...
                if (Shape.IsLocalRayOriginInMesh(ref ray, out hit))
                {
                    ...
                    hit = new RayHit() { Location = startingTransform.Position, Normal = new Vector3(), T = Fix64.C0 };
                    return true;
                }
            }
            hit = new RayHit();
