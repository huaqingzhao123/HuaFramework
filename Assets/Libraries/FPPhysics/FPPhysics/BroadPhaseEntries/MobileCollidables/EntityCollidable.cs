...
namespace FPPhysics.BroadPhaseEntries.MobileCollidables
{
    ...
    public abstract class EntityCollidable : MobileCollidable
    {
        ...
        {
            UpdateBoundingBoxForTransform(ref transform, Fix64.C0);
        }
