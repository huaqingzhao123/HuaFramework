...
namespace FPPhysics.Constraints.TwoEntity.Motors
{
    /// <summary>
    ...
    public class TwistMotor : Motor, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public override void Update(Fix64 dt)
        {
            ...
            if (settings.mode == MotorMode.Servomechanism)
            {
                ...
                settings.servo.springSettings.ComputeErrorReductionAndSoftness(dt, Fix64.C1 / dt, out errorReduction, out usedSoftness);
            ...
            velocityToImpulse = Fix64.C1 / (usedSoftness + entryA + entryB);
        ...
        private Fix64 GetDistanceFromGoal(Fix64 angle)
        {
            ...
            if (goalAngle > Fix64.C0)
            {
                if (angle > goalAngle)
                    forwardDistance = angle - goalAngle;
                else if (angle > Fix64.C0)
