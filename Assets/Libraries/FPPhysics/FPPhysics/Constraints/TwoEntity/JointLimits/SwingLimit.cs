...
namespace FPPhysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class SwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private Fix64 minimumCosine = Fix64.C1;
        private Fix64 error;
        ...
        public Fix64 MaximumAngle
        {
            ...
            set { minimumCosine = Fix64.Cos(MathHelper.Clamp(value, Fix64.C0, MathHelper.Pi)); }
        }
        ...
        public override void Update(Fix64 dt)
        {
            ...
            error = MathHelper.Max(Fix64.C0, minimumCosine - dot - margin);
