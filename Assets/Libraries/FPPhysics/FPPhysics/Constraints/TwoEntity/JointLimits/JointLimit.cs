...
namespace FPPhysics.Constraints.TwoEntity.JointLimits
{
    ...
    public abstract class JointLimit : Joint
    {
        ...
        /// </summary>
        protected Fix64 bounceVelocityThreshold = Fix64.C1;
        ...
        public Fix64 BounceVelocityThreshold
        {
            ...
            set { bounceVelocityThreshold = MathHelper.Max(Fix64.C0, value); }
        }
        ...
        public Fix64 Bounciness
        {
            ...
            set { bounciness = MathHelper.Clamp(value, Fix64.C0, Fix64.C1); }
        }
        ...
        {
            get { return margin; }
            set { margin = MathHelper.Max(value, Fix64.C0); }
        }
        ...
        {
            var lowThreshold = bounceVelocityThreshold * Fix64.C0p3;
            var velocityFraction = MathHelper.Clamp((impactVelocity - lowThreshold) / (bounceVelocityThreshold - lowThreshold + Toolbox.Epsilon), Fix64.C0, Fix64.C1);
