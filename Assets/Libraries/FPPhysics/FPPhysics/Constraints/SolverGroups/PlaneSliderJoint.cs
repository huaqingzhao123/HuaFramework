using FPPhysics.Constraints.TwoEntity;
using FPPhysics.Constraints.TwoEntity.JointLimits;
using FPPhysics.Constraints.TwoEntity.Joints;
using FPPhysics.Constraints.TwoEntity.Motors;
using FPPhysics.Entities;


namespace FPPhysics.Constraints.SolverGroups
{
    /// <summary>
    ...
    public class PlaneSliderJoint : SolverGroup
    {
        ...
        public PlaneSliderJoint(Entity connectionA, Entity connectionB, Vector3 planeAnchor, Vector3 planeNormal, Vector3 xAxis, Vector3 yAxis, Vector3 pointAnchor)
        {
            ...
            LimitX = new LinearAxisLimit(connectionA, connectionB, planeAnchor, pointAnchor, xAxis, Fix64.C0, Fix64.C0);
            MotorX = new LinearAxisMotor(connectionA, connectionB, planeAnchor, pointAnchor, xAxis);
            LimitY = new LinearAxisLimit(connectionA, connectionB, planeAnchor, pointAnchor, yAxis, Fix64.C0, Fix64.C0);
