...
namespace FPPhysics.Vehicle
{
    ...
    public class WheelBrake : ISolverSettings
    {
        ...
        private Fix64 staticFrictionVelocityThreshold = Fix64.C5;
        private Wheel wheel;
        ...
        public Fix64 KineticBrakingFrictionCoefficient
        {
            ...
            set { kineticBrakingFrictionCoefficient = MathHelper.Max(value, Fix64.C0); }
        }
        ...
        public Fix64 RollingFrictionCoefficient
        {
            ...
            set { rollingFrictionCoefficient = MathHelper.Max(value, Fix64.C0); }
        }
        ...
        public Fix64 StaticBrakingFrictionCoefficient
        {
            ...
            set { staticBrakingFrictionCoefficient = MathHelper.Max(value, Fix64.C0); }
        }
