...
namespace FPPhysics.Vehicle
{
    ...
    public class WheelSuspension : ISpringSettings, ISolverSettings
    {
        ...
        public Fix64 AllowedCompression
        {
            ...
            set { allowedCompression = MathHelper.Max(Fix64.C0, value); }
        }
        ...
        public Fix64 MaximumSpringCorrectionSpeed
        {
            ...
            set { maximumSpringCorrectionSpeed = MathHelper.Max(Fix64.C0, value); }
        }
        ...
        public Fix64 MaximumSpringForce
        {
            ...
            set { maximumSpringForce = MathHelper.Max(Fix64.C0, value); }
        }
        ...
        internal Fix64 ApplyImpulse()
        {
            ...
            accumulatedImpulse = MathHelper.Clamp(accumulatedImpulse + lambda, -maximumSpringForce, Fix64.C0);
        ...
        internal void PreStep(Fix64 dt)
        {
            ...
            Fix64 biasFactor;
            springSettings.ComputeErrorReductionAndSoftness(dt, Fix64.C1 / dt, out biasFactor, out softness);

            velocityToImpulse = -1 / (entryA + entryB + softness);

            //Correction velocity
            bias = MathHelper.Min(MathHelper.Max(Fix64.C0, (restLength - currentLength) - allowedCompression) * biasFactor, maximumSpringCorrectionSpeed);
