...
namespace Nireus
{
    ...
    public class SpawnPoolsDict : IDictionary<string, SpawnPool>
    {
        ...
        private bool assertValidPoolName(string poolName)
        {
            ...
            {
                GameDebug.Log(string.Format("A pool with the name '{0}' already exists",
                                        poolName));
                return false;
            }
        ...
        public void DestroyAll()
        {
			...
			{
				GameDebug.Log("DESTROYING: " + pair.Value.gameObject.name);
        ...
        internal void Add(SpawnPool spawnPool)
        {
            ...
            {
                GameDebug.LogError(string.Format("A pool with the name '{0}' already exists. " +
			...
			//GameDebug.Log(string.Format("Added pool '{0}'", spawnPool.poolName));
        ...
        internal bool Remove(SpawnPool spawnPool)
        {
            ...
            {
                GameDebug.LogError(string.Format(
