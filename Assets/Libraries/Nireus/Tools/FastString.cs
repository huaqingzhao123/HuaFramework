...
public class FastString
{
    ...
    public FastString Set<T1, T2>( T1 str1, T2 str2 )
    {
        Clear();
        Append( str1 ); Append( str2 );
        return this; 
    }
    public FastString Set<T1, T2, T3>( T1 str1, T2 str2, T3 str3 )
    {
        Clear();
        Append( str1 ); Append( str2 ); Append( str3 );
        return this;
    }
    public FastString Set<T1, T2, T3, T4>( T1 str1, T2 str2, T3 str3, T4 str4 )
    {
        Clear();
    ...
    public FastString Set( params object[] str )
    {
        Clear();
