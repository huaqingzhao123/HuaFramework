...
namespace Framework
{
    ...
    public static class SimpleJsonTool
    {
        ...
        public static object DeserializeObject(object obj, Type type)
        {
           return  SimpleJsonTool.CurrentJsonSerializerStrategy.DeserializeObject(obj, type);
        ...
        private static bool SerializeValue(IJsonSerializerStrategy jsonSerializerStrategy, object value, StringBuilder builder)
        {
            ...
            else
            {
                ...
                {
                        //UnityEngine.GameDebug.Log("===>>IEnumerable");
