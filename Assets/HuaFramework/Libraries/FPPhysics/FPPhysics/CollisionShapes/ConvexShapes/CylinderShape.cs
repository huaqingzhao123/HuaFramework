...
namespace FPPhysics.CollisionShapes.ConvexShapes
{
    ...
    public class CylinderShape : ConvexShape
    {
        ...
        ///</summary>
        public Fix64 Height { get { return halfHeight * Fix64.C2; } set { halfHeight = value * Fix64.C0p5; OnShapeChanged(); } }
        ...
        public static ConvexShapeDescription ComputeDescription(Fix64 height, Fix64 radius, Fix64 collisionMargin)
        {
            ...
            Fix64 diagValue = (Fix64.C0p0833333333 * height * height + Fix64.C0p25 * radius * radius);
            ...
            Fix64 halfHeight = height * Fix64.C0p5;
        ...
        public override void GetLocalExtremePointWithoutMargin(ref Vector3 direction, out Vector3 extremePoint)
        {
            ...
            {
                extremePoint = new Vector3(Fix64.C0, Fix64.Sign(direction.y) * (halfHeight - collisionMargin), Fix64.C0);
            }
        }
        ...
        public override bool RayTest(ref Ray ray, ref RigidTransform transform, Fix64 maximumLength, out RayHit hit)
        {
            ...
            Fix64 backwardsDistance = radius * Fix64.Sqrt(Fix64.C1 - squaredDistance / (radius * radius));
            ...
            if (localRay.Direction.y > Fix64.Cm1em9)
            {
            ...
            if (planeIntersection.x * planeIntersection.x + planeIntersection.z * planeIntersection.z < radius * radius + Fix64.C1em9 && t < maximumLength)
            {
                //Pull the hit into world space.
            ...
            if (localRay.Direction.y < Fix64.C1em9)
            {
