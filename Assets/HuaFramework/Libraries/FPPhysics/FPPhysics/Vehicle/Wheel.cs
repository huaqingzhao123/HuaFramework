...
namespace FPPhysics.Vehicle
{
    ...
    public class Wheel
    {
        ...
        internal Vector3 localForwardDirection = new Vector3(Fix64.C0, Fix64.C0, -1);
        ...
        {
            Matrix4x4.CreateFromAxisAngle(ref suspension.localDirection, shape.steeringAngle, out shape.steeringTransform);
            Matrix4x4.TransformNormal(ref localForwardDirection, ref shape.steeringTransform, out worldForwardDirection);
            ...
            else
            {
                ...
                suspension.accumulatedImpulse = Fix64.C0;
                slidingFriction.accumulatedImpulse = Fix64.C0;
                drivingMotor.accumulatedImpulse = Fix64.C0;
                brake.accumulatedImpulse = Fix64.C0;
            }
        }
