...
namespace FPPhysics.CollisionTests.Manifolds
{
    ...
    public class BoxSphereContactManifold : ContactManifold
    {
        ...
        public override void Update(Fix64 dt)
        {
            ...
            {
                if (!previouslyColliding && contactData.PenetrationDepth >= Fix64.C0)//Don't use the contact if it's an initial contact and the depth is negative.  Why not? Bounciness and InitialCollisionDetected.
                {
                    Add(ref contactData);
                    colliding = true;
                }
