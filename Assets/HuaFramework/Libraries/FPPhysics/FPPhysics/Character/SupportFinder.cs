...
namespace FPPhysics.Character
{
    ...
    public class SupportFinder
    {
        ...
        Fix64 maximumAssistedDownStepHeight = Fix64.C1;
        /// <summary>
        ...
        public Fix64 MaximumAssistedDownStepHeight
        {
            ...
            set
            {
                maximumAssistedDownStepHeight = MathHelper.Max(value, Fix64.C0);
            }
        }
        ...
        private void UpdateSupportData(ref Vector3 down)
        {
            ...
            if (contacts.Count > 1)
            {
                ...
                {
                    Vector3.Multiply(ref supportData.Normal, Fix64.C1 / Fix64.Sqrt(length), out supportData.Normal);
                }
            }
        ...
        public void UpdateSupports(ref Vector3 movementDirection)
        {
            ...
            Fix64 rayCastInnerRadius = MathHelper.Max((extremePoint.x + convexShape.collisionMargin) * Fix64.C0p8, extremePoint.x);
            ...
            if (!HasSupport && hadTraction)
            {
                ...
                bool tryingToMove = movementDirection.LengthSquared() > Fix64.C0;
                if (!HasTraction && tryingToMove)
                {
                    ...
                    if (!QueryManager.RayCastHitAnything(obstructionRay, Fix64.C1))
                    {
