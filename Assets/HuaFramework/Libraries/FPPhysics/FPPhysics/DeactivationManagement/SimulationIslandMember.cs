...
namespace FPPhysics.DeactivationManagement
{
    /// <summary>
    ...
    public class SimulationIslandMember
    {
            ...
            if (isActive)
            {
                ...
                if (IsDynamic)
                {
                    ...
                    if (velocity < DeactivationManager.velocityLowerLimitSquared)
                        ...
                        velocityTimeBelowLimit = Fix64.C0;
                ...
                else
                {
                    ...
                    IsDeactivationCandidate = velocity == Fix64.C0 && !IsAlwaysActive;
                    ...
                    if (IsDeactivationCandidate)
                    {
                        ...
                        if (velocityTimeBelowLimit == Fix64.C0)
                            velocityTimeBelowLimit = Fix64.C1;
                        else if (velocityTimeBelowLimit < Fix64.C0)
                            velocityTimeBelowLimit = Fix64.C0;
                    }
                    else
                    {
        ...
        internal FPPhysics.SpinLock simulationIslandChangeLocker = new FPPhysics.SpinLock();
        ...
        public bool IsActive
        {
            get
            {
                ...
                else
                {
                    ...
                    return velocityTimeBelowLimit <= Fix64.C0;
                }
            }
