...
namespace FPPhysics.Paths
{
    ...
    public abstract class SpeedControlledCurve<TValue> : Path<TValue>
    {
        ...
        public Fix64 GetInnerTime(Fix64 time)
        {
            ...
            return (Fix64.C1 - curveTime) * samples[indexMin].SpeedControlled + (curveTime) * samples[indexMin + 1].SpeedControlled;
        }
