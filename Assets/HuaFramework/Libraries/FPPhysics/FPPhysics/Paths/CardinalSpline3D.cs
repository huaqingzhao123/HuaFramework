namespace FPPhysics.Paths
{
    ...
    public class CardinalSpline3D : HermiteCurve3D
    {
        ...
        {
            get { return tension; }
            set { tension = MathHelper.Clamp(value, Fix64.C0, Fix64.C1); }
        }
        ...
        protected override void ComputeTangents()
        {
            ...
            for (int i = 1; i < ControlPoints.Count - 1; i++)
            {
                ...
                Vector3.Multiply(ref tangent, (Fix64)((Fix64.C1 - tension) / (ControlPoints[i + 1].Time - ControlPoints[i - 1].Time)), out tangent);
