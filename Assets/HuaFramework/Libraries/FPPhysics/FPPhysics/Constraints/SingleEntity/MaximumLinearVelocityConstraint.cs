...
namespace FPPhysics.Constraints.SingleEntity
{
    /// <summary>
    ...
    public class MaximumLinearSpeedConstraint : SingleEntityConstraint, I3DImpulseConstraint
    {
        ...
        public Fix64 MaximumForce
        {
            get
            {
                if (maximumForce > Fix64.C0)
                {
                    return maximumForce;
                }
                return Fix64.C0;
            }
            set { maximumForce = value >= Fix64.C0 ? value : Fix64.C0; }
        }
        ...
        public Fix64 MaximumSpeed
        {
            ...
            set
            {
                maximumSpeed = MathHelper.Max(Fix64.C0, value);
        ...
        public override void Update(Fix64 dt)
        {
            ...
            effectiveMassMatrix = Fix64.C1 / (entity.inverseMass + usedSoftness);
