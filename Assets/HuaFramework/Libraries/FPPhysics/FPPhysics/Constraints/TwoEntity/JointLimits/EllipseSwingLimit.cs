...
namespace FPPhysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class EllipseSwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public override void Update(Fix64 dt)
        {
            ...
            Vector2 tangent;
#endif
            tangent.x = Fix64.C2 * angleX / maxAngleXSquared;
            tangent.y = Fix64.C2 * angleY / maxAngleYSquared;
            ...
            error = error - margin;
            biasVelocity = MathHelper.Min(MathHelper.Max(error, Fix64.C0) * errorReduction, maxCorrectiveVelocity);
            ...
            velocityToImpulse = Fix64.C1 / (softness + entryA + entryB);
