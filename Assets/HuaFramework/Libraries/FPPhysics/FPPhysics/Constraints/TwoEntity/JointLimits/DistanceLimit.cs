...
namespace FPPhysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class DistanceLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Fix64 MaximumLength
        {
            ...
            set
            {
                maximumLength = MathHelper.Max(Fix64.C0, value);
        ...
        public Fix64 MinimumLength
        {
            ...
            set
            {
                minimumLength = MathHelper.Max(Fix64.C0, value);
        ...
        public override void Update(Fix64 dt)
        {
            ...
            velocityToImpulse = Fix64.C1 / (softness + velocityToImpulse);
            ...
            if (distance > maximumLength)
                error = MathHelper.Max(Fix64.C0, distance - maximumLength - Margin);
            else
                error = MathHelper.Max(Fix64.C0, minimumLength - Margin - distance);
