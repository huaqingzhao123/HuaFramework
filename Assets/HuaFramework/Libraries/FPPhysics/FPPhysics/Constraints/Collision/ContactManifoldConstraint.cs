...
using FPPhysics.Constraints.SolverGroups;
...
namespace FPPhysics.Constraints.Collision
{
    ...
    public abstract class ContactManifoldConstraint : SolverGroup
    {
        ...
        public void UpdateMaterialProperties(Material materialA, Material materialB)
        {
            ...
            {
                materialInteraction.KineticFriction = Fix64.C0;
                materialInteraction.StaticFriction = Fix64.C0;
                materialInteraction.Bounciness = Fix64.C0;
            }
        }
