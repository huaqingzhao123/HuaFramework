...
namespace FPPhysics.Constraints
{
    /// <summary>
    ...
    public class SpringAdvancedSettings
    {
        ...
        public Fix64 ErrorReductionFactor
        {
            ...
            set { errorReductionFactor = MathHelper.Clamp(value, Fix64.C0, Fix64.C1); }
        }
        ...
        {
            get { return softness; }
            set { softness = MathHelper.Max(Fix64.C0, value); }
        }
    ...
    public class SpringSettings
    {
        ...
        internal Fix64 damping = Fix64.C90000;
        internal Fix64 stiffness = Fix64.C600000;
        ...
        {
            get { return damping; }
            set { damping = MathHelper.Max(Fix64.C0, value); }
        }
        ...
        public Fix64 Stiffness
        {
            ...
            set { stiffness = MathHelper.Max(Fix64.C0, value); }
        }
