...
namespace FPPhysics
{
    ...
    public static class Toolbox
    {
        ...
        /// </summary>
        public static Fix64 BigEpsilon = Fix64.C1 / new Fix64(100000);

        /// <summary>
        /// Tolerance value. Defaults to 1e-7f.
        /// </summary>
        public static Fix64 Epsilon = Fix64.C1 / new Fix64(10000000);
        ...
        /// Reference for a vector with dimensions (0,0,-1).
        /// </summary>
        public static Vector3 ForwardVector = Vector3.back;
        ...
        /// </summary>
        public static Matrix4x4 ZeroMatrix = new Matrix4x4(Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0, Fix64.C0);
        ...
        public static bool FindRayTriangleIntersection(ref Ray ray, Fix64 maximumLength, ref Vector3 a, ref Vector3 b, ref Vector3 c, out bool hitClockwise, out RayHit hit)
        {
            ...
            hit.T /= d;
            if (hit.T < Fix64.C0 || hit.T > maximumLength)
            ...
            Fix64 denom = Fix64.C1 / (ABdotAB * ACdotAC - ABdotAC * ABdotAC);
            Fix64 u = (ACdotAC * ABdotAP - ABdotAC * ACdotAP) * denom;
            Fix64 v = (ABdotAB * ACdotAP - ABdotAC * ABdotAP) * denom;

            return (u >= -Toolbox.BigEpsilon) && (v >= -Toolbox.BigEpsilon) && (u + v <= Fix64.C1 + Toolbox.BigEpsilon);
        }
        ...
        public static bool FindRayTriangleIntersection(ref Ray ray, Fix64 maximumLength, TriangleSidedness sidedness, ref Vector3 a, ref Vector3 b, ref Vector3 c, out RayHit hit)
        {
            ...
            switch (sidedness)
            {
                case TriangleSidedness.DoubleSided:
                    if (d <= Fix64.C0) //Pointing the wrong way.  Flip the normal.
                    {
                ...
                case TriangleSidedness.Clockwise:
                    if (d <= Fix64.C0) //Pointing the wrong way.  Can't hit.
                        return false;
        ...
        {
            Fix64 t;
            return GetLinePlaneIntersection(ref a, ref b, ref p, out t, out q) && t >= Fix64.C0 && t <= Fix64.C1;
        }
        ...
        #endregion Segment/Ray-Triangle Tests
        ...
        public static VoronoiRegion GetClosestPointOnTriangleToPoint(ref Vector3 a, ref Vector3 b, ref Vector3 c, ref Vector3 p, out Vector3 closestPoint)
        {
            ...
            if (vc <= Fix64.C0 && d1 >= Fix64.C0 && d3 <= Fix64.C0)
            {
                v = d1 / (d1 - d3);
            ...
            if (vb <= Fix64.C0 && d2 >= Fix64.C0 && d6 <= Fix64.C0)
            {
                w = d2 / (d2 - d6);
            ...
            if (va <= Fix64.C0 && (d4 - d3) >= Fix64.C0 && (d5 - d6) >= Fix64.C0)
            {
                w = (d4 - d3) / ((d4 - d3) + (d5 - d6));
        ...
        #endregion Point-Triangle Tests
                                                           ...
                                                           out Fix64 s, out Fix64 t, out Vector3 c1, out Vector3 c2)
        {
            ...
            if (a <= Epsilon)
            {
                ...
                s = Fix64.C0;
                t = MathHelper.Clamp(f / e, Fix64.C0, Fix64.C1);
            }
            else
            {
                ...
                if (e <= Epsilon)
                {
                    ...
                    t = Fix64.C0;
                    s = MathHelper.Clamp(-c / a, Fix64.C0, Fix64.C1);
                }
                else
                {
                    ...
                    if (denom != Fix64.C0)
                        s = MathHelper.Clamp((b * f - c * e) / denom, Fix64.C0, Fix64.C1);
                    ...
                    else if (t > Fix64.C1)
                    {
                        ...
                        t = Fix64.C1;
                        s = MathHelper.Clamp((b - c) / a, Fix64.C0, Fix64.C1);
                    }
                }
            }
        ...
        public static void GetClosestPointOnTetrahedronToPoint(RawList<Vector3> tetrahedron, ref Vector3 p, RawList<int> subsimplex, RawList<Fix64> baryCoords, out Vector3 closestPoint)
        {
            ...
            if (!baryCoordsFound)
            {
                ...
                Fix64 abcd = (new Matrix4x4(tetrahedron[0].x, tetrahedron[0].y, tetrahedron[0].z, Fix64.C1,
                                         tetrahedron[1].x, tetrahedron[1].y, tetrahedron[1].z, Fix64.C1,
                                         tetrahedron[2].x, tetrahedron[2].y, tetrahedron[2].z, Fix64.C1,
                                         tetrahedron[3].x, tetrahedron[3].y, tetrahedron[3].z, Fix64.C1)).Determinant();
                Fix64 pbcd = (new Matrix4x4(p.x, p.y, p.z, Fix64.C1,
                                         tetrahedron[1].x, tetrahedron[1].y, tetrahedron[1].z, Fix64.C1,
                                         tetrahedron[2].x, tetrahedron[2].y, tetrahedron[2].z, Fix64.C1,
                                         tetrahedron[3].x, tetrahedron[3].y, tetrahedron[3].z, Fix64.C1)).Determinant();
                Fix64 apcd = (new Matrix4x4(tetrahedron[0].x, tetrahedron[0].y, tetrahedron[0].z, Fix64.C1,
                                         p.x, p.y, p.z, Fix64.C1,
                                         tetrahedron[2].x, tetrahedron[2].y, tetrahedron[2].z, Fix64.C1,
                                         tetrahedron[3].x, tetrahedron[3].y, tetrahedron[3].z, Fix64.C1)).Determinant();
                Fix64 abpd = (new Matrix4x4(tetrahedron[0].x, tetrahedron[0].y, tetrahedron[0].z, Fix64.C1,
                                         tetrahedron[1].x, tetrahedron[1].y, tetrahedron[1].z, Fix64.C1,
                                         p.x, p.y, p.z, Fix64.C1,
                                         tetrahedron[3].x, tetrahedron[3].y, tetrahedron[3].z, Fix64.C1)).Determinant();
                abcd = Fix64.C1 / abcd;
                ...
                baryCoords.Add(Fix64.C1 - baryCoords[0] - baryCoords[1] - baryCoords[2]); //x = 1-u-v-w
            }
            CommonResources.GiveBack(subsimplexCandidate);
            CommonResources.GiveBack(baryCoordsCandidate);
        }

        #endregion Tetrahedron Tests
        ...
        public static bool RayCastSphere(ref Ray ray, ref Vector3 spherePosition, Fix64 radius, Fix64 maximumLength, out RayHit hit)
        {
            ...
            if (c > Fix64.C0 && b > Fix64.C0)
                return false;
            Fix64 discriminant = b * b - c;
            if (discriminant < Fix64.C0)
                return false;
        ...
        public static void UpdateOrientationRK4(ref Quaternion q, ref Matrix3x3 localInertiaTensorInverse, ref Vector3 angularMomentum, Fix64 dt, out Quaternion newOrientation)
        {
            ...
            Quaternion s2;
            Quaternion.Multiply(ref d1, dt * Fix64.C0p5, out s2);
            ...
            Quaternion s3;
            Quaternion.Multiply(ref d2, dt * Fix64.C0p5, out s3);
            ...
            Quaternion.Multiply(ref d1, dt / Fix64.C6, out d1);
            Quaternion.Multiply(ref d2, dt / Fix64.C3, out d2);
            Quaternion.Multiply(ref d3, dt / Fix64.C3, out d3);
            Quaternion.Multiply(ref d4, dt / Fix64.C6, out d4);
            Quaternion added;
        ...
        public static void DifferentiateQuaternion(ref Quaternion orientation, ref Matrix3x3 localInertiaTensorInverse, ref Vector3 angularMomentum, out Quaternion orientationChange)
        {
            ...
            Vector3.Multiply(ref halfspin, Fix64.C0p5, out halfspin);
            var halfspinQuaternion = new Quaternion(halfspin.x, halfspin.y, halfspin.z, Fix64.C0);
        ...
        public static void GetBarycentricCoordinates(ref Vector3 p, ref Vector3 a, ref Vector3 b, ref Vector3 c, out Fix64 aWeight, out Fix64 bWeight, out Fix64 cWeight)
        {
            ...
            Fix64 x = triangleNormal.x < Fix64.C0 ? -triangleNormal.x : triangleNormal.x;
            Fix64 y = triangleNormal.y < Fix64.C0 ? -triangleNormal.y : triangleNormal.y;
            Fix64 z = triangleNormal.z < Fix64.C0 ? -triangleNormal.z : triangleNormal.z;
            ...
            if (denominator < Fix64.Cm1em9 || denominator > Fix64.C1em9)
            {
                denominator = Fix64.C1 / denominator;
                aWeight = numeratorU * denominator;
                bWeight = numeratorV * denominator;
                cWeight = Fix64.C1 - aWeight - bWeight;
            }
            else
            {
