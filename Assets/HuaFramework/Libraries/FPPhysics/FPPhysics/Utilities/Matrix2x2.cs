namespace FPPhysics
{
    ...
    public struct Matrix2x2
    {
        ...
        {
            get { return new Matrix2x2(Fix64.C1, Fix64.C0, Fix64.C0, Fix64.C1); }
        }
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref Matrix4x4 a, ref Matrix2x2 b, out Matrix2x2 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref Matrix2x2 a, ref Matrix4x4 b, out Matrix2x2 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
        ...
        /// <param name="b">Second matrix to add.</param>
        /// <param name="result">Sum of the two matrices.</param>
        public static void Add(ref Matrix4x4 a, ref Matrix4x4 b, out Matrix2x2 result)
        {
            Fix64 m11 = a.M11 + b.M11;
            Fix64 m12 = a.M12 + b.M12;
        ...
        {
            Fix64 determinantInverse = Fix64.C1 / (matrix.M11 * matrix.M22 - matrix.M12 * matrix.M21);
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref Matrix2x2 a, ref Matrix4x4 b, out Matrix2x2 result)
        {
            Fix64 resultM11 = a.M11 * b.M11 + a.M12 * b.M21;
            Fix64 resultM12 = a.M11 * b.M12 + a.M12 * b.M22;
        ...
        /// <param name="b">Second matrix to multiply.</param>
        /// <param name="result">Product of the multiplication.</param>
        public static void Multiply(ref Matrix4x4 a, ref Matrix2x2 b, out Matrix2x2 result)
        {
            Fix64 resultM11 = a.M11 * b.M11 + a.M12 * b.M21;
            Fix64 resultM12 = a.M11 * b.M12 + a.M12 * b.M22;
