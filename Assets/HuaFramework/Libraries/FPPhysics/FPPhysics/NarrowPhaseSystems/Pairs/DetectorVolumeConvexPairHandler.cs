...
namespace FPPhysics.NarrowPhaseSystems.Pairs
{
    ...
    public class DetectorVolumeConvexPairHandler : DetectorVolumePairHandler
    {
        ...
        private TriangleShape triangle = new TriangleShape { collisionMargin = Fix64.C0 };
        public override void UpdateCollision(Fix64 dt)
        {
            ...
            for (int i = 0; i < overlaps.Count; i++)
            {
                ...
                Vector3.Multiply(ref transform.Position, Fix64.OneThird, out transform.Position);
