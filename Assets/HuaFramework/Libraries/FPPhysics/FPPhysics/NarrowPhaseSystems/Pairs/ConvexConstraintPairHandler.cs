...
namespace FPPhysics.NarrowPhaseSystems.Pairs
{
    ...
    public abstract class ConvexConstraintPairHandler : ConvexPairHandler
    {
        ...
        protected internal override void GetContactInformation(int index, out ContactInformation info)
        {
            ...
            Fix64 totalNormalImpulse = Fix64.C0;
            ...
            if (totalNormalImpulse > Fix64.C0)
                info.FrictionImpulse = (info.NormalImpulse / totalNormalImpulse) * (contactConstraint.slidingFriction.accumulatedImpulse.magnitude + contactConstraint.twistFriction.accumulatedImpulse * radius);
            else
