...
public class ResourceIOTool :MonoBehaviour
{
    ...
    public static string ReadStringByFile(string path)
    {
        ...
        try
        {
            if (!File.Exists(path))
            {
                Nireus.GameDebug.Log("path dont exists ! : " + path);
                return "";
            }
        ...
        {
            Nireus.GameDebug.Log("Load text fail ! message:" + e.Message);
        }
    ...
    //    {
    //        GameDebug.LogError("LoadWWW Error URL: ->" + url + "<- error: " + www.error);
    //    }
    //}
    ...
    public static void DeleteFile(string path)
    {
        ...
        {
            Nireus.GameDebug.Log("File:[" + path + "] dont exists");
        }
    }
    ...
    public static void CreateFile(string path, byte[] byt)
    {
        ...
        {
            GameDebug.LogError("File Create Fail! \n" + e.Message);
        }
    }
