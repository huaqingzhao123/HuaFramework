        ...
        public static float GetBitsPerPixel(TextureImporterFormat format)
        {
            switch (format)
            {
                case TextureImporterFormat.Alpha8: //	 Alpha-only texture format.
                    return 8;
                case TextureImporterFormat.ARGB16: // A color texture format.
                    return 16;
                ...
                case TextureImporterFormat.ARGB32: //Color with an alpha channel texture format.
                    return 32;
                case TextureImporterFormat.RGB16: //Color with an alpha channel texture format.
                    return 16;
                case TextureImporterFormat.R16: // Compressed color texture format.
                    return 16;
                ...
                case TextureImporterFormat.DXT5: // Compressed color with alpha channel texture format.
                    return 8;
                case TextureImporterFormat.RGBA16: // Compressed color with alpha channel texture format.
                    return 16;
...
#pragma warning restore 0618
        ...
        public static int CalculateTextureSizeBytes(Texture tTexture, TextureImporterFormat format)
        {
            ...
            if (tTexture is Texture2D)
            {
                ...
                {
                    if (tWidth % 4 != 0 || tHeight % 4 != 0)
                    {
                        bitsPerPixel = GetBitsPerPixel(TextureImporterFormat.RGBA32);
                    }
                }
